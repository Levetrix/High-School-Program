...
*/
(function() {
	console.log(window.location.hostname.toLowerCase() == "localhost" );
	console.log(window.location.hostname );
	var isdev = (window.location.hostname.toLowerCase() == "localhost");
    "use strict";
    ...
    }, // Next, load scripts that require jQuery. If touch is enabled, load alternate script file with touch support added.
    {
        ...
        nope: ((!isdev)?"/site/programs/ACT_Camp/":"/php-ACT_Camp-HTML/")+"js/script.min.js",
        yep: ((!isdev)?"/site/programs/ACT_Camp/":"/php-ACT_Camp-HTML/")+"js/script-touch.min.js"
    }, // If settings.loadslider is truthy, load the slider script
    {
        test: window.pageSettings.loadslider,
        yep: ((!isdev)?"/site/programs/ACT_Camp/":"/php-ACT_Camp-HTML/")+"js/slider.min.js"
